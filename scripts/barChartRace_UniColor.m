%% Bar Chart Rate Plot (One color version)
% Copyright 2020 Michio Inoue
close all
clear

generateGIF = false; % If you want to create gif file
filename = 'barChartRace_UniColor.gif'; % Specify the output file name

% name of variables
names = ["A","B","C","D","E"];
% names = ["A","B","C","D","E","F","G"]; % Try this
